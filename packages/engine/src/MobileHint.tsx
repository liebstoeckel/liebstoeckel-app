      ...
      {show && (
        <motion.button
          ...
          style={{
            ...
            borderRadius: "999px",
            border: "1px solid var(--brand-border, color-mix(in srgb, var(--brand-text, #fff) 14%, transparent))",
            background: "color-mix(in srgb, var(--brand-surface, #11141b) 88%, transparent)",
