// The contract between the engine's CaptureView and the @present-it/thumbnails
...
export const CAPTURE_FLAG = "__PRESENT_IT_CAPTURE__";
export const SLIDE_COUNT = "__PRESENT_IT_SLIDE_COUNT__";
export const CAPTURE_READY = "__PRESENT_IT_CAPTURE_READY__";
export const CAPTURE_EVENT = "present-it:capture";
