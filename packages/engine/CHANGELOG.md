...
* **engine:** brandThemes — decks define their own brand; t-cycle desktop-only ([b6401b5](https://github.com/limond/liebstoeckel-app/commit/b6401b55246e0481da6bab27e2e3ca778e2cb075))
* **engine:** configurable slide transitions + mobile escape hatch ([9b551ce](https://github.com/limond/liebstoeckel-app/commit/9b551ce06658da8aeaec158e280bb641ccc8f24a))
* **engine:** mobile presenter view — notes-first confidence monitor + ⋮ entry ((internal ADR)) ([4d4cc97](https://github.com/limond/liebstoeckel-app/commit/4d4cc9777c16e364278dffe5209162a085ee14f6))
* **engine:** mobile-friendly deck chrome — device-scale rail, dvh, ⋮ menu ([38c911e](https://github.com/limond/liebstoeckel-app/commit/38c911e69b5d29470700c7aabbfc3199452fdf64))
* **engine:** Plugin instance prop + instance-aware presenter console ([5b4c5d3](https://github.com/limond/liebstoeckel-app/commit/5b4c5d3e56d5b155f137b4b68fb82b86ec6a9284))
* **engine:** presenter console — one tab per type + instance dropdown ((internal ADR)) ([d63afdf](https://github.com/limond/liebstoeckel-app/commit/d63afdfdd01b8d96a36efc44ca162342ca6574c6))
* **engine:** presenter console panel + focus mode ([3f5e9c9](https://github.com/limond/liebstoeckel-app/commit/3f5e9c9ee84ff6261e747e27e6a5837f978d3460))
* **engine:** presenter view shares both QRs (follow-along + drive-from-phone) on Q ([ef1cdcc](https://github.com/limond/liebstoeckel-app/commit/ef1cdcc4ea723beb7a9236eb3f91ea2d7bfa4316))
* **engine:** shared presenter timer via the doc ((internal ADR)) ([8943597](https://github.com/limond/liebstoeckel-app/commit/8943597f58b23c29e9c735000c02ee760118bfac))
...
* **live:** recovery primitives — crash detection + reconnect escalation ((internal ticket)) ([ec86815](https://github.com/limond/liebstoeckel-app/commit/ec8681564c361853006e9d1514c605caf051e64d))
...
* **mobile:** touch navigation, portrait hint, responsive presenter ([4bd616c](https://github.com/limond/liebstoeckel-app/commit/4bd616ce33b629439958643d80d0c61bb9f93fd0))
* **plugin-qa:** ask from any slide via global chrome surfaces ((internal ADR)) ([16e5938](https://github.com/limond/liebstoeckel-app/commit/16e593882a75c3d6bcb9948b3257566d4e29d05d))
...
* **presenter:** prominent step/reveal indicator ([f8e7f6c](https://github.com/limond/liebstoeckel-app/commit/f8e7f6c3a6137e419564d7967ac4ce88fb783c5c))
...
* **engine:** don't fire global deck shortcuts while typing in a plugin input ([230b488](https://github.com/limond/liebstoeckel-app/commit/230b48818ee6006731501128d2785e6276bd8c00))
* **engine:** gate presenter view + presenter-only shortcuts on live role ((internal ADR)) ([e6844d9](https://github.com/limond/liebstoeckel-app/commit/e6844d9de020420c10b7acc3d9b0179a335a3c5a))
* **engine:** gray out presenter Next at deck end (and Prev at start) ([0e85d04](https://github.com/limond/liebstoeckel-app/commit/0e85d04257b48c06ac0ddd331f45cfacaf78e4b4))
* **engine:** isolate each plugin surface's Motion layout so a panel can't steal the slide's rows ([76708a0](https://github.com/limond/liebstoeckel-app/commit/76708a0b19e6319e9736131ccea550f7e37e1949))
* **engine:** Motion-track the ScaledStage transform so layoutId morphs are scale-correct ([a154fbd](https://github.com/limond/liebstoeckel-app/commit/a154fbdee286ad56c998d7006cca254b40b7ffe5))
* **engine:** persistent element — scale-correct, fades with transition, travel vs snap ([65a825c](https://github.com/limond/liebstoeckel-app/commit/65a825ca477e913c9f3e83685ed9b1f93a4c97c0))
* **engine:** position persistent slot elements correctly when the stage is scaled ([f85a3ea](https://github.com/limond/liebstoeckel-app/commit/f85a3eaafc5a2334c092a9fa8f603e57ff30f197))
* **engine:** presenter next-slide preview is pointer-inert ((internal ADR)) ([2b4387f](https://github.com/limond/liebstoeckel-app/commit/2b4387fabeaaa41f1b7560c3efab30e2f6a660f0))
* **engine:** QR overlays dismiss consistently — Esc everywhere + a ✕ on the share ([405d983](https://github.com/limond/liebstoeckel-app/commit/405d983bcb66f375c7cd22ee45e3246be83fec7a))
* **engine:** size the presenter "Next up" preview so it fills its box ([da39584](https://github.com/limond/liebstoeckel-app/commit/da3958421cf60f455cf35d24298edb97828054d7))
...
## [0.3.1](https://github.com/limond/liebstoeckel-app/compare/engine-v0.3.0...engine-v0.3.1) (2026-06-07)
...
## [0.3.0](https://github.com/limond/liebstoeckel-app/compare/engine-v0.2.1...engine-v0.3.0) (2026-06-07)
