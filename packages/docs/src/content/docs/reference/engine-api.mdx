...
<Aside type="tip">
Every page is available as raw Markdown. Use the **Copy Markdown** / **Open in ChatGPT / Claude** buttons at the top of any page, or append `.md` to its URL (e.g. `/reference/engine-api.md`). A [`/llms.txt`](/llms.txt) index lists every page for an assistant to crawl. _(These are generated at build time and resolve on the built/deployed site, not the `astro dev` server.)_
</Aside>
