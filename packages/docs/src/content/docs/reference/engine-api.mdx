---
title: Engine API
description: The public exports of @present-it/engine and its build subpaths.
---

import { Aside } from "@astrojs/starlight/components";

Everything below is from `@present-it/engine` unless noted.
...
| Import | Exports |
| --- | --- |
| `@present-it/engine/build` | `buildDeck`, `buildPluginManifest`, `buildServerBundle` |
| `@present-it/engine/code` (macro) | `codeStory`, `code` — import `with { type: "macro" }` |
| `@present-it/engine/build/thumbnails` | `embedThumbnails`, `extractThumbnails`, `stripThumbnails` |
| `@present-it/thumbnails/build` | `buildDeckWithThumbnails` (drop-in for `buildDeck`, + thumbnails) |
