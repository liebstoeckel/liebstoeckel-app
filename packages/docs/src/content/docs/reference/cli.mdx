...
3. **Global install** (the CLI was installed with `bun add -g`): runs
   `bun add -g @liebstoeckel/cli@latest`. When both shapes apply, both update.
4. **Refreshes the agent skill** wherever it is installed (the deck and your user
