...
Serve a deck for authoring: hot reload plus the dev shell at `/__dev/` (a
sidebar beside the deck), whose first tool is [live annotations](/guides/dev-mode/) an AI agent can apply to
