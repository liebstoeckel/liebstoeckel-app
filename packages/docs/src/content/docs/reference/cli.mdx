---
title: CLI reference
description: The umbrella liebstoeckel command — new, add, registry, build, eject, pack, live, relay, thumbs, export, skill, login, push.
---
...
from `login`; the deck appears in your dashboard's deck list.
...
| Flag | Meaning |
| --- | --- |
| `--title <title>` | deck title (default: the file name) |
