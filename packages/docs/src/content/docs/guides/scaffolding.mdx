...
description: Scaffold visx charts and building blocks into a deck as owned source with `liebstoeckel add` — a shadcn-style registry, not a dependency.
---

import { Aside, LinkCard } from "@astrojs/starlight/components";

Beautiful data slides shouldn't start from a blank file. `liebstoeckel add` scaffolds
ready-made charts and building blocks straight into your deck — **as source you own**,
not a package you import. It's the shadcn model: the code lands in your project, and
...
overwrite, or skip, plus the dependencies it will install — then writes:
