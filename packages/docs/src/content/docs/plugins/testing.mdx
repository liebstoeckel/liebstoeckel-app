...
<Aside type="tip">
This is the highest-value test for a plugin, and it runs in milliseconds with no browser: it checks that shared state agrees across devices.
</Aside>
...
<LinkCard title="Building a plugin" href="/plugins/building-a-plugin/" description="The full plugin walkthrough these tests belong to." />
